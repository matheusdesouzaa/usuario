...
public class SecurityConfig {
    ...
    private final com.matheus.usuario.infrastructure.security.JwtUtil jwtUtil;
    private final UserDetailsService userDetailsService;

    // Construtor para injeção de dependências de JwtUtil e UserDetailsService
    @Autowired
    public SecurityConfig(com.matheus.usuario.infrastructure.security.JwtUtil jwtUtil, UserDetailsService userDetailsService) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        com.matheus.usuario.infrastructure.security.JwtRequestFilter jwtRequestFilter = new com.matheus.usuario.infrastructure.security.JwtRequestFilter(jwtUtil, userDetailsService);
